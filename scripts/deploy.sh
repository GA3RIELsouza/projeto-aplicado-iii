...
# Diretórios necessários e permissões corretas
...
# Para o serviço enquanto mexemos no DB (evita lock)
...
# Entrar no diretório do projeto ajuda o EF com caminhos relativos
cd "${APP_DIR}"
